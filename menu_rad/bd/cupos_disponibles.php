...
$query_cupos = "SELECT PA.nombre_practica AS PRACTICA, CENTRO.nombre_institucion AS CENTRO, 
                PC.cupo_campo AS CUPO, PC.det_semestre AS SEM, SE.nombre_semestre AS NSE, PC.id_campo AS ICAM 
...
<table class="table table-bordered">
    ...
    <tfoot>
        <tr>
            <td colspan="5" align="center">Detalle de actividades</td>
        </tr>
    </tfoot>
    <tbody>
<?php
...
?>
    <tr>
        ...
        <td><?=$datos->NSE?></td>
        <td><?=$datos->CUPO?></td>
        <td> <a class="btn btn-primary" href="inscritos.php?id=<?=$datos->ICAM?>" role="button">Inscritos</a>
        <a class="btn btn-info" href="actualizar_campo.php?id=<?=$datos->ICAM?>" role="button">Actualizar</a> </td>
    </tr>
<?php
endwhile;
} else {
